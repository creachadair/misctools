...
var (
	outputPath = flag.String("out", "", "Output file path (required)")
)
...
func main() {
	...
	fmt.Fprintf(&buf, `// Code generated by %[1]s. DO NOT EDIT.

package %[2]s
`, filepath.Base(os.Args[0]), pkg.Name)

	for _, name := range names {
		gen.GenerateMarshal(&buf, name)
		gen.GenerateUnmarshal(&buf, name)
	}
